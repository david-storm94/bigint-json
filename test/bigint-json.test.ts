...
describe("Tests for bigint json", () => {
  ...
  describe("parse", () => {
    ...
    it("throw error if input is not string", () => {
      expect(bigintJSON.parse.bind(bigintJSON, {})).to.throw(
        "TypeError: Do not know to parse a object"
      );
    });
  ...
  describe("stringify", () => {
    it("should not mutate input object", () => {
      const someKey3 = object.someKey3;
      const nestedKey3 = object.someKey4.nestedKey3;
      const nestedNestedKey3 = object.someKey4.nestedNestedKey3;
    ...
    it("throw error if input is not object", () => {
      expect(bigintJSON.stringify.bind(bigintJSON, "sadfsadfasdf")).to.throw(
        "TypeError: Do not know to stringify a string"
      );
    });
    ...
    it("Should be able to stringify with bigints to JSON", () => {
      const newStringified = bigintJSON.stringify(object);
